...
import { View, Text, StyleSheet, TouchableOpacity, ScrollView, Alert, ActivityIndicator, TextInput, Modal, SafeAreaView, KeyboardAvoidingView, Platform } from 'react-native';
